      ...
      <div className="bg-white/80 backdrop-blur-xl border-t border-gray-200/50 shadow-lg px-6 py-5">
        <div className="max-w-7xl mx-auto flex items-center justify-center space-x-4">
          ...
          {myStream && (
            <button
              onClick={sendStreams}
              className="flex items-center space-x-3 bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white font-bold px-8 py-4 rounded-xl shadow-lg shadow-indigo-500/30 transform hover:scale-105 active:scale-95 transition-all duration-200"
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
              </svg>
              <span className="text-lg">Share Stream</span>
            </button>
          )}
